package javarush.java_core_2.level3.lecture2.task6;
/*
...
4. Метод initializeIdAndName должен присваивать значения полям id и
...
public class Solution {
    ...
    static class User implements DBObject {
        ...
        public String toString() {
            return String.format("User has name %s, id = %Solution", name, id);
        }
