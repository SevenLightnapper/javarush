package javarush.java_multithreading_3.level4.lecture9.task2;
/*
...
public class Solution {
    ...
    public static void sort(List<Stock> list) {
        list.sort(new Comparator<Stock>() {
            ...
            int result = ((Integer) date2.getYear()).compareTo(date1.getYear());
            ...
            if (o1.containsKey("open")) {
                x = (double) (o1.get("last")) - (double) (o1.get("open"));
            } else x = (double) (o1.get("change"));

            if (o2.containsKey("open")) {
                y = (double) (o2.get("last")) - (double) (o2.get("open"));
            } else y = (double) (o2.get("change"));
