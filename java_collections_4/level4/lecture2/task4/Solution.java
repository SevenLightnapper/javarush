package javarush.java_collections_4.level4.lecture2.task4;
/*
...
/*
Имеется три стержня.
На стержень A нанизаны numRings колец, причем кольца отличаются размером и лежат меньшее на большем.
...
public class Solution {
    ...
    //n - число колец, a - имя стержня-источника, b - имя стержня-приемника, c - имя временного стержня
