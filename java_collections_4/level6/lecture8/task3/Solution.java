package javarush.java_collections_4.level6.lecture8.task3;
/*
...
Откуда сеть знает, каких людей предлагать тебе в друзья, которых ты можешь знать?
...
После этого отработает метод removeFriendsFromSet,
...
Пересечение столбца и столбика указывает, добавлены ли люди друг у друга в друзья
...
int deep - глубина поиска друзей.
Если Маша в друзьях у Наташи и у Маши в друзьях есть Оля, при глубине поиска = 1,
