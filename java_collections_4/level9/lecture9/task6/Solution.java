package javarush.java_collections_4.level9.lecture9.task6;
/*
...
Требования:
    ...
    •
    Метод isOneEditAway должен корректно работать для строк одинаковой длины.
    •
    Метод isOneEditAway должен корректно работать для строк разной длины.
    •
    Метод isOneEditAway должен корректно работать для пустых строк.
    •
    Метод isOneEditAway должен быть публичным.
    */
