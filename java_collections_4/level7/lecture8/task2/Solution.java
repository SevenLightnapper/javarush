package javarush.java_collections_4.level7.lecture8.task2;
/*
...
Для клиента (в данном случае класс Solution)
использование SecurityProxyConnector ничем не должно отличаться от использования класса SimpleConnector.
...
Требования:
    ...
    •
    Конструктор класса SecurityProxyConnector должен принимать один параметр типа String
    и инициализировать поле типа SimpleConnector.
    •
    Метод connect класса SecurityProxyConnector должен
    выполнять проверку безопасности с помощью вызова метода performSecurityCheck у объекта типа SecurityChecker.
    •
...
import javarush.java_collections_4.level7.lecture8.task2.connectors.Connector;
import javarush.java_collections_4.level7.lecture8.task2.connectors.SecurityProxyConnector;
import javarush.java_collections_4.level7.lecture8.task2.connectors.SimpleConnector;
